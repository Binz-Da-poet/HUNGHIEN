...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  if (loading) {
    return <div className="container mx-auto px-4 py-20 text-center">Loading product...</div>;
  }
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          <div className="aspect-square w-full rounded-xl bg-gray-100 flex items-center justify-center">
            <span className="text-gray-400 font-medium text-lg">Main Image Placeholder</span>
          </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mb-8 flex flex-col gap-3 text-sm text-gray-600">
            <div className="flex items-center gap-2">
              ...
              <span>In Stock: <span className="font-semibold text-gray-900">{product.stock} items available</span></span>
            </div>
            <div className="flex items-center gap-2">
